...
/**
         ...
         */
function Chart_Data(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _bucket_name, Data_char;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, user_1.User.findById(_bucket_name).exec().then(function (data) {
                            Data_char.chart_write = data.get('Write').filter(function (val) {
                                if (val.Date >= get_current_week_data().firstdate
